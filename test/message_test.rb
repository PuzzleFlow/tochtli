...
class MessageTest < ServiceBase::Test::TestCase
	class SimpleMessage < ServiceBase::Message
	...
	class OpenMessage < ServiceBase::Message
	...
	test 'topic binding' do
		message_class = ServiceBase::MessageMap.instance.for('test.controller.simple')
